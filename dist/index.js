...
app.get("/", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const user = yield getUser(process.env.USERID);
    let text = "Offline";
    ...
    res.setHeader("Cache-Control", `private, no-cache, no-store, must-revalidate, max-age=-200`);
...
const getUser = (discordUserId) => __awaiter(void 0, void 0, void 0, function* () {
    const list = yield client.guilds.fetch(process.env.GUILDID);
    const members = yield list.members.fetch(discordUserId);
